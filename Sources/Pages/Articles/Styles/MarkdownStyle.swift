...
//            .font(size: .percentage(100))
        ...
        let ulStyle = ClassStyle(forClass: .markdown, withTag: .enclosing(.unorderedList))
            .margin(top: .pixel(12), bottom: .pixel(12))
//            .font(size: .percentage(125))
//            .font(size: .pixel(17))
...
//            .border(sides: [.left], width: .pixel(2), color: Color.Dark.NavBarDividerColor)
        ...
        let styles = [h1Style, h2Style, h3Style, pStyle, introStyle, imageStyle, imageCreditsStyle, ulStyle, olStyle, liStyle, blockquoteStyle, paragraphInBlockquoteStyle, linkStyle, linkHoverStyle]
