...
public extension Response {
    ...
    static func article(for request: Request, live host: String, with meta: MetaDetail, tabs: [LinkDescription], listImage: String, analyticsID: String) throws -> Response {
    ...
    static func articles(for request: Request, live host: String, with meta: MetaDetail, tagged tags: [String], tabs: [LinkDescription], analyticsID: String) throws -> Response {
